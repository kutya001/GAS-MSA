...
var SCHEMA = {
  ...
  'Закупки': {
    headers: ['id','purchase_date','wh_id','supplier_id','cost_usd','rate','cost_kgs','has_imei','imei','qty','condition','class_id','type_id','purpose_id','product_id','status','note','created_at'],
...
function _seedData(ss) {
  ...
  _seedSheet(ss, 'Закупки', [
    ['id','purchase_date','wh_id','supplier_id','cost_usd','rate','cost_kgs','has_imei','imei','qty','condition','class_id','type_id','purpose_id','product_id','status','note','created_at'],
