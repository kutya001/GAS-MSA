...
var SCHEMA = {
  ...
  'Ref_Назначения': {
    headers: ['id','type_id','name','info'],
    color: '#E8F5E9', tabColor: '#388E3C', widths: [50,80,250,300],
    note: 'Назначения / форм-фактор (уровень 3, type_id → Ref_ТипыПродуктов)',
  },
  ...
  'Закупки': {
    headers: ['id','brand_id','model_id','spec','color','wh_id','supplier_id','has_imei','imei','qty','condition','purchase_date','cost_usd','rate','cost_kgs','status','note','class_id','type_id','purpose_id','created_at'],
    color: '#EDE7F6', tabColor: '#6A1B9A',
    widths: [50,80,80,120,100,80,80,90,160,60,90,110,90,70,110,100,200,80,80,80,110],
    note: 'has_imei=TRUE → поштучный учёт. status: В наличии / Продано / Удалено. class_id/type_id/purpose_id — 3-уровневая классификация',
  },
  'Продажи': {
  ...
  'MDM_Шаблоны': {
    headers: ['id','class_id','type_id','purpose_id','name','description'],
    color: '#E0F7FA', tabColor: '#00838F',
    widths: [50,80,80,80,250,400],
    note: 'Шаблоны номенклатуры. class_id → Ref_Классы, type_id → Ref_ТипыПродуктов, purpose_id → Ref_Назначения',
  },
  'MDM_Атрибуты': {
...
function _seedData(ss) {
  ...
  // ── Классы → Типы → Назначения (3-уровневая классификация товаров)
  ...
  _seedSheet(ss, 'Ref_Назначения', [
    ['id','type_id','name','info'],
    [1,3,'TWS','True Wireless'],
    [2,3,'Накладные наушники',''],
    [3,3,'Проводные наушники',''],
    [4,3,'Портативная акустика',''],
    [5,4,'Чехлы',''],
    [6,4,'Защитные стекла',''],
    [7,4,'Пленки',''],
    [8,5,'Сетевые ЗУ',''],
  ...
  _seedSheet(ss, 'Закупки', [
    ['id','brand_id','model_id','spec','color','wh_id','supplier_id','has_imei','imei','qty','condition','purchase_date','cost_usd','rate','cost_kgs','status','note','class_id','type_id','purpose_id','created_at'],
    [1,1,1,'256GB','Чёрный',1,1,'TRUE','352365010000001',1,'Новый',m3ago,430,88,37840,'Продано','',1,1,'',m3ago],
    [2,1,2,'128GB','Белый',1,1,'TRUE','352365010000002',1,'Новый',m2ago,370,88,32560,'Продано','',1,1,'',m2ago],
    [3,1,3,'128GB','Голубой',1,1,'TRUE','352365010000003',1,'Новый',m2ago,290,88,25520,'В наличии','',1,1,'',m2ago],
    [4,1,4,'128GB','Фиолет.',1,3,'TRUE','352365010000004',1,'Новый',m3ago,250,88,22000,'В наличии','',1,1,'',m3ago],
    [5,1,5,'128GB','Красный',2,1,'TRUE','352365010000005',1,'Новый',m1ago,195,89,17355,'В наличии','',1,1,'',m1ago],
    [6,2,6,'12/256','Серый',1,2,'TRUE','860000060000001',1,'Новый',m2ago,550,88,48400,'Продано','',1,1,'',m2ago],
    [7,2,7,'8/256','Белый',1,2,'TRUE','860000070000001',1,'Новый',m1ago,320,88,28160,'В наличии','',1,1,'',m1ago],
    [8,2,8,'8/128','Лавандов.',2,4,'TRUE','860000080000001',1,'Новый',m0,180,89,16020,'В наличии','',1,1,'',m0],
    [9,2,9,'6/128','Чёрный',3,4,'FALSE','',5,'Новый',m1ago,130,88,11440,'В наличии','Партия 5 шт',1,1,'',m1ago],
    [10,3,10,'8/256','Синий',1,2,'TRUE','860001000000001',1,'Новый',m1ago,140,88,12320,'Продано','',1,1,'',m1ago],
    [11,3,11,'6/128','Зелёный',1,2,'TRUE','860001100000001',1,'Новый',m0,88,89,7832,'В наличии','',1,1,'',m0],
    [12,3,12,'8/256','Чёрный',2,3,'TRUE','860001200000001',1,'Новый',m0,165,89,14685,'В наличии','',1,1,'',m0],
    [13,4,14,'12/256','Серебр.',1,3,'FALSE','',3,'Новый',m0,170,88,14960,'В наличии','Партия 3 шт',1,1,'',m0],
    [14,5,16,'4/128','Синий',3,4,'TRUE','350001400000001',1,'Новый',m0,65,89,5785,'В наличии','',1,1,'',m0],
  ]);
...
function _seedMDM(ss) {
  ...
  // ── Шаблоны (class_id → type_id → purpose_id) ───────────────────────
  _seedSheet(ss, 'MDM_Шаблоны', [
    ['id','class_id','type_id','purpose_id','name','description'],
    [1, 1, 1, '', 'Смартфоны', 'Шаблон для мобильных телефонов'],
    [2, 1, 2, '', 'Планшеты', 'Шаблон для планшетов'],
    [3, 2, 3, 1, 'TWS наушники', 'Беспроводные наушники'],
    [4, 2, 4, 5, 'Чехлы', 'Защитные чехлы для устройств'],
    [5, 2, 4, 6, 'Защитные стекла', 'Стёкла для экранов'],
    [6, 2, 5, 8, 'Сетевые ЗУ', 'Зарядные устройства'],
  ]);
